...
(function() {
	...
	Window_ScrollText.prototype.processEscapeCharacter = function(code, textState) {
		switch (code) {
		case '\#':
			var linelenght = textState.text.split(/\r\n|\r|\n/)
			this.villaA_paddingleft = (this.width - this.textWidth(linelenght[this.villaA_procLine]))/2;
			break;
		case '\_':
			var linelenght = textState.text.split(/\r\n|\r|\n/)
			this.villaA_paddingleft = this.width - this.textWidth(linelenght[this.villaA_procLine]) - 20;
			break;
		default:
			Window_Base.prototype.processEscapeCharacter.call(this, code, textState);
			break;
	...
	var _Window_ScrollText_startScrollText = Window_ScrollText.prototype.startScrollText
	Window_ScrollText.prototype.startScrollText = function() {
			_Window_ScrollText_startScrollText.call(this);
			this.villaA_procLine = 0;
	};
