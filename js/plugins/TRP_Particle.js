...
/*  added 9 lines below 2021.01.07 NEKOMA */
if (StorageManager.isExistTestData) {
	var StorageManager_isExistTestData = StorageManager.isExistTestData;
	StorageManager.isExistTestData = function(fileName) {
		if (fileName.match(/^TrpParticles/)) {
			return true;
		}
		return StorageManager_isExistTestData.call(this, fileName);
	};
}
