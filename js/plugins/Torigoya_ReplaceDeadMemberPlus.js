...
(function (global) {
    ...
    // added by nekoma.
    // BattleManager.updateEventの戻り値を保存
    var upstream_BattleManager_updateEvent = BattleManager.updateEvent;
    BattleManager.updateEvent = function () {
        this._updateEventResult = upstream_BattleManager_updateEvent.apply(this);
        return this._updateEventResult;
    };
    ...
    BattleManager.update = function () {
        ...
        // if (!this.isBusy() && !this.updateEvent()) {     // modified by nekoma.
        if (!this.isBusy() && !this._updateEventResult) {   // modified by nekoma.
            switch (this._phase) {
