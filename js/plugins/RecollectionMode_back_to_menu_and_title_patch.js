...
//-----------------------------------------------------------------------------
    ...
    (__initialize => {
        Game_Temp.prototype.initialize = function() {
            ...
            this._mapDisplayName = [];
        };
    })(Game_Temp.prototype.initialize);

    (__displayName => {
        Game_Map.prototype.displayName = function() {
            return $gameTemp._mapDisplayName[this.mapId()] || __displayName.apply(this, arguments);
        };
    })(Game_Map.prototype.displayName);

    (__onMapLoaded => {
        Scene_Map.prototype.onMapLoaded = function() {
            __onMapLoaded.apply(this, arguments);
            $gameTemp._mapDisplayName[$gameMap.mapId()] = $dataMap.displayName;
        };
