 ...
 *
 * ===========================================================================
 * オーラを有効にするには、メモ欄に下記のタグを記入してください。
 *
 * aura effect: Z_INDEX:TYPE:FILE_NAME:OPACITY:BLENDMODE:ROTATION
 *
 * Z_INDEX - 画像のZ値を設定します。 (0から1)
 *            0  - 敵の画像の下
 *            1  - 敵の画像の上。
 *
 * TYPE - アニメーションタイプ(0から2)
 *         0  - なし
 *         1  - パルス
 *         2  - ズーム
 *
 * FILE_NAME =ファイル名(敵の画像を使用する場合、"battler"と定義します)
 * BLENDMODE = ブレンドモード(0から2)
 * ROTATION  = 画像を回転させる速度。
 *
 * 例
 *
 ...
 *
 * ===========================================================================
 * パーティクルを有効にするには、メモ欄に下記のタグを記入してください。
 *
 * particle effect: Z_INDEX:POWER:FILE_NAME:BLEND_MODE:SPEED_X:SPEED_Y
 *
 * Z_INDEX - 画像のZ値を設定します。 (0から1)
